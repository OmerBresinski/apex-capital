      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-12 pt-20">
        ...
        >
          ...
          >
            ...
            <Link
              href="/about"
              className="text-[#f5f2eb] font-body text-sm tracking-wide hover:text-[#c9a227] transition-colors link-hover"
            >
              Our Approach
            </Link>
          </motion.div>
            ...
            <div className="hidden md:flex items-center gap-16">
              {[
                ...
                >
                  ...
                  <span className="text-xs text-[#f5f2eb]/50 font-body uppercase tracking-wider">
                    {stat.label}
                  </span>
                </motion.div>
              ))}
