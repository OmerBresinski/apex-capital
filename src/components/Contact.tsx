...
export default function Contact() {
  return (
    <section className="relative py-32 overflow-hidden">
      ...
      {/* Decorative glows */}
      <div className="absolute left-1/4 top-0 w-96 h-96 bg-[#c9a227]/5 rounded-full blur-[150px]" />
      <div className="absolute right-1/4 bottom-0 w-64 h-64 bg-[#c9a227]/5 rounded-full blur-[120px]" />

      {/* Large decorative number */}
      <div className="absolute right-0 top-1/2 -translate-y-1/2 display-number text-[20rem] text-[#f5f2eb]/[0.02] pointer-events-none select-none hidden lg:block">
        &
      </div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-12 text-center">
        ...
        >
          ...
          <p className="text-lg text-[#f5f2eb]/50 mb-12 font-body font-light max-w-2xl mx-auto">
        ...
        >
          ...
          <a
            ...
            className="group px-10 py-5 border border-[#c9a227]/30 text-[#c9a227] font-body text-sm tracking-wide hover:bg-[#c9a227] hover:text-[#0a0a0a] transition-all duration-300"
          >
