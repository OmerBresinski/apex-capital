...
export default function Footer() {
  return (
    <footer className="relative bg-[#f5f2eb] border-t border-[#1a1a1a]/10 overflow-hidden">
      {/* Background pattern */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          >
            ...
            <p className="text-[#6b6b6b] font-body text-sm max-w-xs leading-relaxed">
            ...
            <ul className="space-y-4">
              {footerLinks.map((link) => (
                <li key={link.name}>
                  <Link
                    href={link.href}
                    className="text-[#4a4a4a] font-body text-sm hover:text-[#c9a227] transition-colors duration-300 link-hover"
                  >
                    {link.name}
                  </Link>
                </li>
            ...
            <ul className="space-y-4">
              <li>
                <a
                  ...
                  className="text-[#4a4a4a] font-body text-sm hover:text-[#c9a227] transition-colors duration-300"
                >
                  hello@apexcap.vc
                </a>
              </li>
              <li>
                <div className="flex items-center gap-4 mt-6">
                  <a
                    href="#"
                    className="text-[#6b6b6b] hover:text-[#c9a227] transition-colors duration-300"
                  >
        ...
        <div className="pt-8 border-t border-[#1a1a1a]/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <p className="text-[#9a9a9a] text-xs font-body max-w-lg text-center md:text-right">
