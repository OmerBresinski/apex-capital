...
export default function Footer() {
  return (
    <footer className="relative bg-[#0a0a0a] border-t border-[#f5f2eb]/10 overflow-hidden">
      {/* Background pattern */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          >
            ...
            <p className="text-[#f5f2eb]/40 font-body text-sm max-w-xs leading-relaxed">
            ...
            <ul className="space-y-4">
              {footerLinks.map((link) => (
                <li key={link.name}>
                  <Link
                    href={link.href}
                    className="text-[#f5f2eb]/60 font-body text-sm hover:text-[#c9a227] transition-colors duration-300 link-hover"
                  >
                    {link.name}
                  </Link>
                </li>
            ...
            <ul className="space-y-4">
              <li>
                <a
                  ...
                  className="text-[#f5f2eb]/60 font-body text-sm hover:text-[#c9a227] transition-colors duration-300"
                >
                  hello@apexcap.vc
                </a>
              </li>
              <li>
                <div className="flex items-center gap-4 mt-6">
                  <a
                    href="#"
                    className="text-[#f5f2eb]/40 hover:text-[#c9a227] transition-colors duration-300"
                  >
        ...
        {/* Bottom bar */}
        <div className="pt-8 border-t border-[#f5f2eb]/5">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-[#f5f2eb]/30 text-xs font-body">
              &copy; {new Date().getFullYear()} Apex Capital. All rights reserved.
            </p>
            <p className="text-[#f5f2eb]/20 text-xs font-body max-w-lg text-center md:text-right">
