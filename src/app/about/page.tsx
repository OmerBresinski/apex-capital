  ...
  return (
    <main className="bg-[#0a0a0a]">
      ...
      <section className="relative py-32 px-6 overflow-hidden">
        ...
        <div className="absolute right-0 top-0 w-96 h-96 bg-[#c9a227]/5 rounded-full blur-[150px]" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-[#f5f2eb]/60 font-body font-light leading-relaxed">
                <p>
                ...
                <div className="grid grid-cols-2 gap-8">
                  {[
                    ...
                    >
                      ...
                      <div className="text-[#f5f2eb]/40 font-body text-sm uppercase tracking-wider">{stat.label}</div>
                    </motion.div>
                  ))}
                </div>
              </div>
            ...
            {values.map((value, i) => (
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-[#f5f2eb]/50 font-body font-light leading-relaxed">
                    {value.description}
                  </p>
                </div>
              </motion.div>
      ...
      <section className="relative py-32 px-6 overflow-hidden">
        <div className="absolute inset-0 bg-[#141414]" />
        <div className="absolute inset-0 diagonal-lines" />
        <div className="absolute left-1/2 -translate-x-1/2 top-0 w-96 h-96 bg-[#c9a227]/5 rounded-full blur-[150px]" />
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/portfolio"
                className="inline-flex items-center justify-center gap-3 px-8 py-4 border border-[#c9a227]/30 text-[#c9a227] font-body text-sm tracking-wide hover:bg-[#c9a227] hover:text-[#0a0a0a] transition-all duration-300"
              >
                View Portfolio
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
