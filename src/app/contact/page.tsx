  ...
  return (
    <main className="bg-[#0a0a0a]">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center px-6 pt-20 overflow-hidden">
        ...
        <div className="absolute left-1/4 top-1/2 -translate-y-1/2 w-96 h-96 bg-[#c9a227]/5 rounded-full blur-[150px]" />
        <div className="absolute right-1/4 bottom-0 w-64 h-64 bg-[#c9a227]/5 rounded-full blur-[120px]" />
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <motion.p
            ...
            className="text-xl text-[#f5f2eb]/60 font-body font-light max-w-2xl mx-auto"
          >
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {contacts.map((item, i) => (
              <motion.a
                ...
                className="group relative bg-[#141414] p-8 overflow-hidden"
              >
                {/* Hover gradient */}
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-[#f5f2eb]/50 text-sm font-body mb-4">{item.description}</p>
      ...
      <section className="relative py-16 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl mx-auto">
          ...
          >
            ...
            <h2 className="font-display text-3xl text-[#f5f2eb]">
              Send us a message
            </h2>
          </motion.div>
          ...
          >
            <div className="grid sm:grid-cols-2 gap-6">
              <input
                type="text"
                placeholder="Name"
                className="w-full px-5 py-4 bg-[#0a0a0a] border border-[#f5f2eb]/10 text-[#f5f2eb] placeholder-[#f5f2eb]/30 focus:border-[#c9a227] focus:outline-none font-body transition-colors duration-300"
              />
              <input
                type="email"
                placeholder="Email"
            ...
            <select className="w-full px-5 py-4 bg-[#0a0a0a] border border-[#f5f2eb]/10 text-[#f5f2eb]/60 focus:border-[#c9a227] focus:outline-none font-body transition-colors duration-300">
            ...
            <textarea
              ...
              className="w-full px-5 py-4 bg-[#0a0a0a] border border-[#f5f2eb]/10 text-[#f5f2eb] placeholder-[#f5f2eb]/30 focus:border-[#c9a227] focus:outline-none font-body resize-none transition-colors duration-300"
            />
            <div className="text-center">
              <button
                type="submit"
                className="inline-flex items-center gap-3 px-10 py-5 bg-[#c9a227] text-[#0a0a0a] font-body text-sm font-medium tracking-wide hover:bg-[#e3bc4a] transition-all duration-300"
              >
                Send Message
                <svg
                  className="w-4 h-4"
      ...
      <section className="relative py-16 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          >
            ...
            <h2 className="font-display text-3xl text-[#f5f2eb]">Our Offices</h2>
          </motion.div>
          ...
          <div className="flex flex-wrap justify-center gap-16">
            {offices.map((office, i) => (
              ...
              >
                <h3 className="font-display text-2xl text-[#f5f2eb] mb-2">{office.city}</h3>
                <p className="text-[#f5f2eb]/40 text-sm font-body">{office.address}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="relative py-16 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <div className="flex items-center justify-center gap-8">
            <a
              href="#"
              className="group flex items-center gap-2 text-[#f5f2eb]/40 hover:text-[#c9a227] transition-colors duration-300"
            >
