      ...
      <section className="py-16 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {contacts.map((item, i) => (
              <motion.a
                key={`${pathname}-contact-${item.title}`}
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-[#f5f2eb]/50 text-sm font-body mb-4 transition-colors duration-300">{item.description}</p>
          ...
          >
            <div className="grid sm:grid-cols-2 gap-6">
              <input
                type="text"
                placeholder="Name"
                className="w-full px-5 py-4 bg-[#1a1a1a] border border-[#f5f2eb]/10 text-[#f5f2eb] placeholder-[#f5f2eb]/40 focus:border-[#c9a227] focus:outline-none font-body transition-colors duration-300"
              />
              <input
                type="email"
                placeholder="Email"
            ...
            <select className="w-full px-5 py-4 bg-[#1a1a1a] border border-[#f5f2eb]/10 text-[#f5f2eb]/40 focus:border-[#c9a227] focus:outline-none font-body transition-colors duration-300">
            ...
            <textarea
              ...
              className="w-full px-5 py-4 bg-[#1a1a1a] border border-[#f5f2eb]/10 text-[#f5f2eb] placeholder-[#f5f2eb]/40 focus:border-[#c9a227] focus:outline-none font-body resize-none transition-colors duration-300"
            />
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-16">
            {offices.map((office, i) => (
              <motion.div
                key={`${pathname}-office-${office.city}`}
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5, delay: i * 0.1 }}
              ...
              >
                ...
                <p className="text-[#f5f2eb]/50 text-sm font-body">{office.address}</p>
              </motion.div>
            ))}
          </div>
        </div>
