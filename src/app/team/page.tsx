  ...
  return (
    <main className="bg-[#0a0a0a]">
      ...
      <section className="relative pt-32 pb-16 px-6 overflow-hidden">
        ...
        <div className="absolute left-0 top-1/2 -translate-y-1/2 w-96 h-96 bg-[#c9a227]/5 rounded-full blur-[150px]" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-[#f5f2eb]/60 font-body font-light max-w-xl">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {leadership.map((member, i) => (
              <motion.div
                ...
                className="group relative bg-[#141414] overflow-hidden"
              >
                {/* Hover gradient */}
                ...
                <div className="relative z-10 flex gap-6 p-8">
                  ...
                  <div className="flex-1">
                    <h3 className="font-display text-2xl text-[#f5f2eb] mb-1 group-hover:text-[#c9a227] transition-colors duration-300">
                      {member.name}
                    </h3>
                    <p className="text-[#c9a227] text-sm font-body mb-3">
                      {member.role}
                    </p>
                    <p className="text-[#f5f2eb]/50 text-sm font-body font-light leading-relaxed">
                      {member.bio}
                    </p>

                    {/* Social links */}
                    <div className="mt-4 flex items-center gap-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      <a href="#" className="text-[#f5f2eb]/40 hover:text-[#c9a227] transition-colors">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {team.map((member, i) => (
              <motion.div
                ...
                className="group flex items-center gap-5 p-4 bg-[#0a0a0a]/50 hover:bg-[#0a0a0a] transition-colors duration-300"
              >
                {/* Avatar */}
                ...
                <div>
                  <h3 className="font-display text-lg text-[#f5f2eb] group-hover:text-[#c9a227] transition-colors duration-300">
                    {member.name}
                  </h3>
                  <p className="text-[#f5f2eb]/40 text-sm font-body">
                    {member.role}
                  </p>
                </div>
              </motion.div>
      ...
      <section className="relative py-32 px-6 overflow-hidden">
        ...
        <div className="absolute right-1/4 top-1/2 -translate-y-1/2 w-96 h-96 bg-[#c9a227]/5 rounded-full blur-[150px]" />
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          >
            <h2 className="font-display text-4xl md:text-5xl leading-[1.1] mb-6">
              <span className="text-[#f5f2eb]">Join our</span>{" "}
              <span className="italic text-[#c9a227]">team</span>
            </h2>
            <p className="text-[#f5f2eb]/50 font-body font-light mb-10 max-w-lg mx-auto">
