        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {leadership.map((member, i) => (
              <motion.div
                key={`${pathname}-leader-${member.name}`}
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5, delay: i * 0.1 }}
                className="group relative bg-[#1a1a1a] overflow-hidden border border-[#f5f2eb]/10 group-hover:border-[#c9a227]/30 transition-colors duration-500"
              >
                {/* Hover gradient */}
                ...
                <div className="relative z-10 flex gap-6 p-8">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-[#f5f2eb]/50 text-sm font-body font-light leading-relaxed transition-colors duration-300">
                      {member.bio}
                    </p>

                    {/* Social links */}
                    <div className="mt-4 flex items-center gap-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      <a href="#" className="text-[#f5f2eb]/50 hover:text-[#c9a227] transition-colors">
      ...
      <section className="relative py-16 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {team.map((member, i) => (
              <motion.div
                key={`${pathname}-team-${member.name}`}
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.4, delay: i * 0.05 }}
                className="group flex items-center gap-5 p-4 bg-[#1a1a1a] border border-[#f5f2eb]/10 hover:border-[#c9a227]/30 transition-colors duration-300"
              >
                {/* Avatar */}
                ...
                <div>
                  ...
                  <p className="text-[#f5f2eb]/50 text-sm font-body transition-colors duration-300">
                    {member.role}
                  </p>
                </div>
              </motion.div>
